...
window.onload = function () {
    ...
    require("electron").ipcRenderer.on("prediction", function (event, message) {
        console.log(message); // Prints 'predictions!'
    });
    ...
    function init() {
        // Load images
        images = loadImages(["games/bubbleShooter/bubble-sprites.png"]);
...
//# sourceMappingURL=bubble-shooter-example.js.map